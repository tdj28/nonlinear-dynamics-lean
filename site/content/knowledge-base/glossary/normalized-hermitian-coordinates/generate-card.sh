...
source_svg="$script_dir/n2-coordinate-normalizations.svg"
...
generate() {
  output="$1"
  fit="$(mktemp /tmp/normalized-hermitian-coordinates-fit.XXXXXX)"
  rsvg-convert -w 840 -h 630 -b '#f7f1e7' -o "$fit" "$source_svg"
