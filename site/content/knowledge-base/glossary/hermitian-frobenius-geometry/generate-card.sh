...
source_svg="$script_dir/hermitian-frobenius-geometry.svg"
...
generate() {
  output="$1"
  fit="$(mktemp /tmp/hermitian-frobenius-geometry-fit.XXXXXX)"
  rsvg-convert -w 864 -h 630 -b '#f7f1e7' -o "$fit" "$source_svg"
