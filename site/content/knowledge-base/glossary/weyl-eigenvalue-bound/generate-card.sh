...
source_svg="$script_dir/ordered-eigenvalue-budget-example.svg"
...
generate() {
  output="$1"
  fit="$(mktemp /tmp/weyl-eigenvalue-bound-fit.XXXXXX)"
  rsvg-convert -w 969 -h 630 -b '#f7f1e7' -o "$fit" "$source_svg"
