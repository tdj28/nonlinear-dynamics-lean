...
source_svg="$script_dir/empirical-spectrum-3x3-ledger.svg"
...
generate() {
  output="$1"
  fit="$(mktemp /tmp/empirical-spectral-measure-fit.XXXXXX)"
  rsvg-convert -w 756 -h 630 -b '#f7f1e7' -o "$fit" "$source_svg"
