...
The balanced law also proves only one specified symmetry. Full unitary
invariance quantifies over every unitary matrix, not merely \(S\) or the
two-element subgroup generated by \(S\).
