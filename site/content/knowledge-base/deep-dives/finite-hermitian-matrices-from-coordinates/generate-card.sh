...
source_svg="$script_dir/two-by-two-coordinate-reconstruction.svg"
...
generate() {
  output="$1"
  fit="$(mktemp /tmp/finite-hermitian-coordinates-fit.XXXXXX)"
  rsvg-convert -w 875 -h 630 -b '#f7f1e7' -o "$fit" "$source_svg"
