...
source_svg="$script_dir/anisotropic-coordinate-ledger.svg"
...
generate() {
  output="$1"
  fit="$(mktemp /tmp/complex-gaussian-coordinates-fit.XXXXXX)"
  rsvg-convert -w 879 -h 630 -b '#f7f1e7' -o "$fit" "$source_svg"
